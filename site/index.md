...
<div class="home-section" id="features">
  <h2>产品特性</h2>
  <p class="sec-sub">知识的挂载、检索、演进与传播，覆盖在一套工具里。</p>
  ...
  <div class="feature-grid">
    <div class="fcard">
      ...
      <h3>知识包模型</h3>
      <p>仓库、本地、云端三类知识根统一为知识包，用 <code>kb.yaml</code> 声明清单、版本与依赖。</p>
    </div>
    <div class="fcard">
      ...
      <h3>组合配置</h3>
      <p>按用户、环境与任务目标激活不同 profile，装配结果由 lockfile 固定。</p>
    </div>
    <div class="fcard">
      ...
      <h3>生命周期管理</h3>
      <p>收件箱 → 证据 → 常青 → 原则四态演进，淘汰的内容进入归档而非消失。</p>
    </div>
    <div class="fcard">
      ...
      <h3>跨包检索</h3>
      <p>tag、文件名、全文三层加权打分，CLI 与 agent 工具用同一套实现。</p>
    </div>
    <div class="fcard">
      ...
      <h3>云端 git 同步</h3>
      <p>clone / pull / push 三条原语，把同一份知识同步到多台机器。</p>
    </div>
    <div class="fcard">
      ...
      <h3>知识更新流</h3>
      <p>契约块锚定引用关系，源头一改，受影响的页面自动进入待更新队列。</p>
    </div>
    <div class="fcard">
      ...
      <h3>后台守护</h3>
      <p>文件变更后增量重索引，并按周期执行生命周期扫描与云端同步。</p>
    </div>
    <div class="fcard">
      ...
      <h3>Agent 原生</h3>
      <p>以插件形态运行：服务端守护、控制台面板、agent 工具面与技能包。</p>
    </div>
  </div>
</div>
...
<div class="home-section" id="how-it-works">
  <h2>三步接入</h2>
  <p class="sec-sub">从挂载到日常维护，都在一个 CLI 里完成。</p>
  <div class="steps">
    <div class="step">
      <h3>挂载知识根</h3>
      <p><code>myco mount repo:/path/to/kb</code> —— 仓库、本地、云端三类知识根，统一为知识包。</p>
    </div>
    <div class="step">
      <h3>建立跨包索引</h3>
      <p><code>myco index</code> —— 建立全库倒排索引，此后由 daemon 跟随文件变更增量更新。</p>
    </div>
    <div class="step">
      <h3>检索与维护</h3>
      <p><code>myco find</code> 即问即答，<code>myco sweep</code> 给出生命周期候选，由你决定是否处理。</p>
    </div>
  </div>
</div>
...
<div class="home-section">
  ...
  <div class="doc-cards">
    ...
    <a class="doc-card" href="/design/overview">
      ...
      <h3>系统设计</h3>
      <p>运行时形态、数据模型、检索打分与知识更新流的工程实现。</p>
...
<div class="cta-band">
  <div class="cta-box">
    <h2>让知识像菌丝网络一样生长</h2>
    <p>挂载你的知识库，几分钟后即可通过 CLI 与 agent 检索。</p>
    <a class="myco-btn primary" href="/docs/quickstart">快速开始</a>
    <a class="myco-btn ghost" href="/releases" style="margin-left: 10px;">版本发布</a>
  </div>
</div>
