...
<div class="rm-item">
  <h3><span class="rm-tag next">NEXT</span>v0.4 —— 按任务动态装配</h3>
  <p>根据任务目标动态装配 profile 与工具面，让 agent 拿到「刚好够用」的知识与工具组合。</p>
</div>
...
→ v0.5 知识更新流（数据层+控制台+webhook+subagent 起草）✅
→ v0.4 动态装配（规划中）→ 后续：更新流深化、多用户协作
```
