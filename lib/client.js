...
window.__ModuleLoader__?.load?.({
  ...
  factory: (require) => {
    ...
    function SyncSettingsSection({ myco, t }) {
      ...
      children.push(React.createElement('div', { style: { fontSize: '11px', color: 'var(--dsw-alias-label-dimmed, #888)', marginBottom: '8px' } },
        t('sync.hint')))
      if (clouds.length === 0) {
        ...
        for (const c of clouds) {
          children.push(React.createElement('label', {
            ...
            React.createElement('span', { style: { color: 'var(--dsw-alias-label-dimmed, #888)' } },
    ...
    function TelemetrySection({ myco, t }) {
      ...
      if (cfg) {
        ...
        if (!cfg.url) {
          children.push(React.createElement('div', { style: { fontSize: '11px', color: 'var(--dsw-alias-label-dimmed, #888)' } },
      ...
      children.push(React.createElement('div', { style: { fontSize: '11px', marginTop: '6px' } },
        React.createElement('a', {
          ...
          style: { color: 'var(--dsw-alias-link, #0f766e)' },
        }, t('telemetry.docs')),
      ))
      return React.createElement('div', { style: sectionStyle() }, children)
    }
    ...
    function AssembleSection({ myco, t }) {
      ...
      if (result) {
        ...
        children.push(React.createElement('div', { style: { fontSize: '12px', marginTop: '8px', color: 'var(--dsw-alias-label-dimmed, #888)' } },
